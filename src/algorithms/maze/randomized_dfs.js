 ...
 * The algorithm starts from a given cell and explores randomly chosen neighbors
 * until all cells are visited, creating a random maze pattern.
 */
...
// Recursive depth-first search function to explore and create the maze.
